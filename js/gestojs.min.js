var j=null,m=!1;window.d.l={P:function(){return!!("ontouchstart"in window)},s:function(c){return"function"===typeof c}};(function(c){c.c.F=function(){function a(a){for(var b=[],e=[],c,h,f=-1,g=0,i;g<a.length;g++){h=a[g].startTime;c=[];for(i=0;i<e.length;i++)h<e[i].n&&c.push(e[i]);e=c;e.length||(f++,b[f]={time:h,tracks:[]});b[f].g.push(a[g]);e.push(a[g])}return b}var b={};this.r=function(b,l){var e,n=/[a-z0-9]+\([^\)]*\)/gi,h=[],f=a(b),g,i,p,r,w,t,u,z,x,s;for(w in l)if(t=l[w].b,t.length===f.length){for(g=i=0;g<t.length;g++)if(u=t[g],u=u.split(/&&/g),p=u.length,x=f[g].g.length,x!==p)i=0;else{for(s=p=0;s<x;s++){z=0;e=
{tracks:b,steps:f,step:f[g],track:f[g].g[s]};u[s]=u[s].replace(n,function(a){var b,i;try{b=a.match(/^([^\(]+)/)[1],i=a.match(/\(([^\)]*)/)[1].split(",")}catch(t){return c.o('Parsing error in "'+a+'": '+t.toString()),0}if(!c.e[b])return c.o('Undefined analyzer "'+b+'"'),0;a=f[g].g[s].r(b,[e].concat(i));z++;return a});if(!(r=eval(u[s]))){p=0;break}p+=r/z}if(!p){i=0;break}i+=p/x}i&&h.push({name:w,points:i/t.length})}return h.length?(h.sort(function(a,b){return a.a>b.a?1:a.a<b.a?-1:0}),h):j};this.addListener=
function(a,c){b[a]||(b[a]=[]);b[a].push({t:(new Date).getTime(),f:c})};this.removeListener=function(a,c){var e;if(c)for(e=0;e<b[a];e++)b[a][e].R===c&&b[a].splice(e,1);else delete b[a]}}})(window.d);var o=window.d;
...
1;return this.a[b].k(this.a[a])};this.O=function(){return this.a[this.a.length-1].i(this.a[Math.max(0,this.a.length-2)])/(this.a[this.a.length-1].time-this.a[Math.max(0,this.a.length-2)].time)/1E3};this.r=function(a,b){return o.e[a].apply(this,b)}};window.d.event={G:"onGesture",m:"onTrackProgress",w:"onTrackStart",q:"onTrackComplete",v:function(c){this.timestamp=(new Date).getTime();this.type=c;this.g=this.L=this.D=j}};var q=window.d;q.c.h=function(c,a,b,k){this.time=(new Date).getTime();this.x=c;this.y=a;this.size=b||1;this.S=k||1;this.i=function(a){return Math.sqrt((a.x-this.x)*(a.x-this.x)+(a.y-this.y)*(a.y-this.y))};this.k=function(a){return Math.atan2(a.y-this.y,a.x-this.x)};this.A=function(){return(new q.c.h(0,0)).k(this)};this.T=function(){return new q.c.h(-this.x,-this.y,b,k)}};var v=window.d;
v.c.H=function(c){function a(a,b){var g=0,c;if(h[a]){c=new v.event.v(a);c.g=b.g;for(c.D=b.D;g<h[a].length;g++)h[a][g].method.call(this,c)}}function b(){f.sort(function(a,b){return a.startTime>b.startTime?1:a.startTime<b.startTime?-1:0});a(v.event.q,{tracks:f,originalEvent:j});f=[];g={};i=0;r=j}function k(c){var i={},e=0;if(f.length){c.preventDefault();if(!p||!c.touches.length)r=setTimeout(b,n.J);if(p){for(;e<c.touches.length;e++)i[c.touches[e].identifier]=!0;for(e=0;e<f.length;e++)i[g[f[e].id]]||(f[e].end(),
delete g[f[e].id]);a(v.event.m,{tracks:f,originalEvent:c})}else for(e=0;e<f.length;e++)f[e].end()}}function l(b){var c=0,e;if(f.length&&!r){b.preventDefault();if(p)for(;c<b.touches.length;c++)e=b.touches[c],f[g[e.identifier]]?f[g[e.identifier]].push(new v.c.h(e.pageX,e.pageY)):v.o("Fixme! Attemp to move unstarted touch !?");else f[f.length-1].push(new v.c.h(b.pageX,b.pageY));a(v.event.m,{tracks:f,originalEvent:b})}}function e(b){var e=0,c,h;b.preventDefault();r&&(clearTimeout(r),r=j);f.length||(a(v.event.w,
{originalEvent:b}),h=!0);if(p)for(;e<b.touches.length;e++)c=b.touches[e],void 0===g[c.identifier]&&(g[c.identifier]=i++,f[g[c.identifier]]=new v.c.z(c.identifier),f[g[c.identifier]].push(new v.c.h(c.pageX,c.pageY)));else f.push(new v.c.z(f.length)),f[f.length-1].push(new v.c.h(b.pageX,b.pageY));h||a(v.event.m,{tracks:f,originalEvent:b})}var n=this,h={},f=[],g={},i=0,p=v.l.P(),r;this.J=120;this.addListener=function(a,b){h[a]||(h[a]=[]);h[a].push({method:b})};this.removeListener=function(a,b){var c;
if(b)for(c=0;c<h[a];c++)h[a][c].method===b&&h[a].splice(c,1);else delete h[a]};try{p?(c.addEventListener("touchstart",e,m),window.addEventListener("touchmove",l,m),window.addEventListener("touchend",k,m)):(c.addEventListener("mousedown",e,m),window.addEventListener("mousemove",l,m),window.addEventListener("mouseup",k,m))}catch(w){v.o(w.toString(),w)}};function y(c,a){function b(a){var b;if(e[a.type])for(b=0;b<e[a.type].length;b++)e[a.type][b].call(k,a)}var k=this,l={},e={},n,h;this.enabled=!0;this.I=function(a){y.log("Listening gesture ",a);l[a]={priority:0,gesture:y.b[a]}};this.U=function(a){delete l[a]};this.addEventListener=function(a,b){e[a]||(e[a]=[]);e[a].push(b)};this.removeEventListener=function(a,b){var c;if(e[a]){for(c=0;c<e[a].length;c++)e[a][c]!==b&&(void 0).push(e[a][c]);e[a]=void 0}};var f;n=new y.c.H(c||window);n.addListener(y.event.w,
